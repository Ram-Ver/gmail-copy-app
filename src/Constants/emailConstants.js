...
const DELETE__EMAIL__REQUESTED = "DELETE__EMAIL__REQUESTED";
const DELETE__EMAIL__FAILURE = "DELETE__EMAIL__FAILURE";
const DELETE__EMAIL__SUCCESS = "DELETE__EMAIL__SUCCESS";
